...
/**
 * @Title: JitNotRecGoodsJobEveryDayJob.java
 * @Package: com.hanthink.gps.jit.job
 * @Description: 拉动未收货情况汇报/天-6点
 * @author dtp
 * @date 2018-8-21
 */
public class JitNotRecGoodsJobEveryDayJob extends BaseJob{
	...
	private final static String FILE_NAME_AF_SUP = "总装未收货每日汇报(供应商)";
	private final static String FILE_NAME_WE_SUP = "焊装未收货每日汇报(供应商)";
	private final static String FILE_NAME_ENG_SUP = "发动机未收货每日汇报(供应商)";
	private final static String FILE_NAME_AF_WX = "总装未收货每日汇报(外协)";
	private final static String FILE_NAME_WE_WX = "焊装未收货每日汇报(外协)";
	private final static String FILE_NAME_ENG_WX = "发动机未收货每日汇报(外协)";
