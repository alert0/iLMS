 ...
 *
 */
public class WXProxyServlet  extends HttpServlet {
	...
	protected Logger log = LoggerFactory.getLogger(WXProxyServlet.class);
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(sysUser==null){
			...
			if(StringUtil.isEmpty(code)){
				String rdUrl= SysPropertyUtil.getByAlias("baseUrl") +"/wxproxy?redirect="+redirect;
				String redirectUrl=WeixinConsts.getWxAuthorize(rdUrl);
				//String code2=WeixinConsts.getWxUserInfo(redirectUrl);
