...
public class IdentityManagerImpl extends AbstractManagerImpl<String, Identity> implements IdentityManager{
	@Resource
	IdentityDao identityDao;
	@Override
	protected Dao<String, Identity> getDao() {
		return identityDao;
	}
	...
	public boolean isAliasExisted(String id, String alias) {
		return identityDao.isAliasExisted(id,alias);
	}
	...
	public String getCurIdByAlias(String alias){
		Identity identity=this.identityDao.getByAlias(alias);
	...
	public  Result genResult(Identity identity) {
		...
		int i = 0;
		i = identityDao.updByAlias(identity);
