...
/**
 * @ClassName: JisoOrderDao
 * @Description: 厂外同步订单
 * @author dtp
 * @date 2018年9月17日
 */
public interface JisoOrderDao extends Dao<String, JisoOrderModel>{
	 ...
	 * @date: 2019年2月16日
	 */
	void updatePrintInfoModel(JisoOrderDetailModel jisoOrderDetailModel);

	/**
	 * @Description: 查询DCS订单打印明细  
	 * @param: @param model_q
	 * @param: @return    
	 * @return: List<PubPrintOrderModel>   
	 * @author: dtp
	 * @date: 2019年4月25日
	 */
	List<PubPrintOrderModel> queryJisoOrderDCSDetailList(JisoOrderModel model_q);
