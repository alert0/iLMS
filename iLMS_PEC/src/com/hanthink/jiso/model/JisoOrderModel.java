...
/**
  * <pre> 
  * 描述：MM_JISO_ORDER 实体对象
  * 作者:dtp
  * 日期:2018-09-17 10:04:28
  * </pre>
  */
public class JisoOrderModel extends AbstractModel<String>{
	
	private static final long serialVersionUID = -4071252996172199936L;
	 ...
	 * 工厂
	 */
	protected String curFactoryCode;
	 ...
	 * 到货批次
	 */
	protected String arriveBatchNo;
	
	/**
	 * 到货批次 至
	 */
	protected String arriveBatchNoTo;

	
	public String getCurFactoryCode() {
		return curFactoryCode;
	}

	public void setCurFactoryCode(String curFactoryCode) {
		this.curFactoryCode = curFactoryCode;
	}
	...
	public String getArriveBatchNoTo() {
		return arriveBatchNoTo;
	}

	public void setArriveBatchNoTo(String arriveBatchNoTo) {
		this.arriveBatchNoTo = arriveBatchNoTo;
	}
