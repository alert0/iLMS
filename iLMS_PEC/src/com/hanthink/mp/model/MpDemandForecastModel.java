...
*/ 
public class MpDemandForecastModel extends AbstractModel<String>{
	...
	public String getPartfOrderQty() {
		return partfOrderQty;
	}
	public void setPartfOrderQty(String partfOrderQty) {
		this.partfOrderQty = partfOrderQty;
	}
	...
	public String getLogisticsModeStr() {
		return logisticsModeStr;
	}
	public void setLogisticsModeStr(String logisticsModeStr) {
		this.logisticsModeStr = logisticsModeStr;
	}
