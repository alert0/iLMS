...
/**
 * 
 * @Desc		: 新车型需求计算  Excel导入类
 * @FileName	: MpTrialDemandModelImport.java
 ...
 */
public class MpTrialDemandModelImport extends MpTrialDemandModel {
	/**
	 * 序列号
	 */
     ...
     */
    public static void checkImportData(MpTrialDemandModelImport m) {
        ...
        if(m.getArriveTimeStr() == null || "".equals(m.getArriveTimeStr())){
        	...
        	try {
       		...
       		m.setArriveTimeStr((new Date()).toString());
