...
public class JitInsPrinterConfigDaoImpl extends MyBatisDaoImpl<String, JitInsPrinterConfigModel> implements JitInsPrinterConfigDao{
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<JitInsPrinterConfigModel> queryPkIsConflict(JitInsPrinterConfigModel model) {
		return (List<JitInsPrinterConfigModel>) this.getList("queryPkIsConflict", model);
	}
