...
public class JitReckonDaoImpl extends MyBatisDaoImpl<String, JitPartRemainModel> implements JitReckonDao{
	...
	public PubPlanCodeModel queryReckonExecState(PubPlanCodeModel pubPlanCodeModel) {
		return (PubPlanCodeModel) this.getOne("queryReckonExecState", pubPlanCodeModel);
	}
	...
	public List<JitPartRemainModel> queryPartAndLocationIsExist(JitPartRemainModel model) {
		return (List<JitPartRemainModel>) this.getList("queryPartAndLocationIsExist", model);
	}
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<JitPartRemainLogModel> queryPartRemainLog(Map<String, String> paramMap) {
		return (List<JitPartRemainLogModel>) this.getList("queryPartRemainLog", paramMap);
	}
	...
	public List<JitPartRemainProdModel> queryJitPartRemainLogList(JitPartRemainLogModel model) {
		return (List<JitPartRemainProdModel>) this.getList("queryJitPartRemainLogPage", model);
	}
	...
	public List<PubPlanCodeModel> loadJitReckonPlanCodeComboData(PubPlanCodeModel model) {
		return (List<PubPlanCodeModel>) this.getList("loadJitReckonPlanCodeComboData", model);
	}
