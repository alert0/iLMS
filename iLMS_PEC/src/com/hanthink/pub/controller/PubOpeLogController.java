 ...
 */
@Controller
@RequestMapping("/pub/pubOpeLog")
public class PubOpeLogController extends GenericController{
	@Resource
	PubOpeLogManager pubOpeLogManager;
    ...
    public @ResponseBody PageJson curdlistJson(HttpServletRequest request,
            ...
            PubOpeLogModel model) {
    	String resultMsg=null;
		try {
			DefaultPage p = new DefaultPage(new RowBounds(getQueryFilter(request).getPage().getStartIndex(),
					getQueryFilter(request).getPage().getPageSize()));
			model.setFactoryCode(ContextUtil.getCurrentUser().getCurFactoryCode());
			List<PubOpeLogModel> pageList = (PageList<PubOpeLogModel>) pubOpeLogManager
					.queryPubOpeLogForPage(model, p);
