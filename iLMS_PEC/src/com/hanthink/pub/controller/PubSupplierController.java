...
public class PubSupplierController extends GenericController{
	...
	public void downloadPubSupplierModel(HttpServletRequest request,HttpServletResponse response,
		...
		String[] headers = {
				"出货地代码","供应商代码", "供应商名称", "供应商地址",
				"供应商状态","联系邮箱","联系人","联系手机","联系电话",
		...
		String[] columns = {
				"supFactory","supplierNo", "supplierName", "detailAddr",
				"codeValueName","email", "contact", "mobileNo","telNo",
