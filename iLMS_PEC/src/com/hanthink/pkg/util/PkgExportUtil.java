...
//	        setCellVal(sheet, 39, "C", null == pkgModel.getBoxTypeName() ? "" : pkgModel.getBoxTypeName());  //由显示箱种改为显示箱CODE
	        setCellVal(sheet, 39, "C", null == pkgModel.getBoxCode() ? "" : pkgModel.getBoxCode());
...
//	        setCellVal(sheet, 27, "AF", null == param.get(SUP_PACK_DD) ? "" : param.get(SUP_PACK_DD));//供应商包装联系担当
	        ...
	        setCellVal(sheet, 27, "AF", null == pkgModel.getPackDeptContact() ? "" : pkgModel.getPackDeptContact());//供应商包装联系担当
	        setCellVal(sheet, 27, "R", null == pkgModel.getPackDeptTel() ? "" : pkgModel.getPackDeptTel());//供应商包装联系电话
	        setCellVal(sheet, 28, "R", null == pkgModel.getPackDeptMail() ? "" : pkgModel.getPackDeptMail());//供应商包装联系邮箱
	        //看板位置
	        if("L".equals(pkgModel.getBoardLocation())){
