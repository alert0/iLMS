...
//			writeResultMessage(response.getWriter(),resultMsg,e.getMessage(),ResultMessage.FAIL);
	...
	* @date   2018年10月7日 下午3:55:14
	 ...
	 * @throws  
	 * @author luoxq
	 * @date 2019年1月17日 下午5:16:39
	 */
	@RequestMapping("getPkgUser")
	public @ResponseBody List<PkgPartModel> getPkgUser(HttpServletRequest request, HttpServletResponse response) throws Exception {
		try {
			IUser user = ContextUtil.getCurrentUser();
			List<PkgPartModel> list = pkgPartManager.getPkgUser();
			return list;
		} catch (Exception e) {
			e.printStackTrace();
			log.error(e.toString());
