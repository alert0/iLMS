...
public class PupManualOrderDaoImpl extends MyBatisDaoImpl<String, PupManualOrderModel>
	 ...
	 */
	@Override
	public List<PupManualOrderModel> queryManualOrderForPage(PupManualOrderModel model, Page page) throws Exception {
	 ...
	 */
	@Override
	public void removeManualOders(List<PupManualOrderModel> list) throws Exception {
		this.deleteByKey("removeManualOders", list);
	}
	/**
	 * 手工调整订单页面数据导出实现方法
	 */
	...
	public Integer getCountForImport(Map<String, Object> paramMap) throws Exception {
		return this.sqlSessionTemplate.selectOne("getCountManualForImport", paramMap);
	}
	
	@SuppressWarnings("unchecked")
	@Override
	public List<String> queryUpdateList(Map<String, Object> paramMap) throws Exception {
		return this.getList("queryManualUpdateList", paramMap);
	}
	 ...
	 */
	@Override
	public Integer getCountForUpdate(Map<String, Object> paramMap) throws Exception {
		return this.sqlSessionTemplate.selectOne("getCouuntForUpdate", paramMap);
	}
	...
	public List<PupManualOrderModel> queryManualOrderTempDataForExport(Map<String, String> paramMap) throws Exception {
		return this.sqlSessionTemplate.selectList("queryImportManualOrderForPage",paramMap);
	}
}
