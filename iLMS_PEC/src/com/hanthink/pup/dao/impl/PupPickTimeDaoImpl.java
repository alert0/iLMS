...
public class PupPickTimeDaoImpl extends MyBatisDaoImpl<String, PupPickTimeModel>
	...
	@Override
	public PupPickTimeModel getPickTime(PupPickTimeModel model) throws Exception {
		return (PupPickTimeModel) this.getOne("getPickTimeByRouteCode", model);
	}
	...
	@Override
	public void removeByRouteCodes(List<PupPickTimeModel> models) throws Exception {
		this.deleteByKey("removeByRouteCodes", models);
	}
	...
	public Integer getCountForImport(Map<String, Object> paramMap) throws Exception {
		return this.sqlSessionTemplate.selectOne("getCountForPickTimeImport", paramMap);
	}
	
	@SuppressWarnings("unchecked")
	@Override
	public List<String> getUpdateList(Map<String, Object> paramMap) throws Exception {
		return this.getList("getUpdateList", paramMap);
	}
	
	@Override
	public Integer getCountForUpdate(Map<String, Object> paramMap) throws Exception {
		return this.sqlSessionTemplate.selectOne("getCountForUpdate", paramMap);
	}
