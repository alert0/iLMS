...
public interface PupRouteMessageDao extends Dao<String, PupRouteMessageModel>{
	 ...
	 * @date 2018年9月21日
	 */
	List<PupRouteMessageModel> queryRouteMessageForPage(PupRouteMessageModel model,Page page)throws Exception;
	/**
	 * 加载数据字典选项
	 * @return
	 * @throws Exception
	 ...
	 * @date 2018年10月21日
	 */
	void deleteRouteMessageFromRegula(Map<String, Object> paramMap)throws Exception;
	/**
	 * 获取单条数据详情
	 * @param id
	 * @return
