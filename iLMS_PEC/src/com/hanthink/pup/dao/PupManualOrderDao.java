...
public interface PupManualOrderDao extends Dao<String,PupManualOrderModel>{
	 ...
	 * @date 2018年9月24日
	 */
	List<PupManualOrderModel> queryManualOrderForPage(PupManualOrderModel model,Page page)throws Exception;
	/**
	 * 手工调整订单删除数据持久层接口
	 * @param list
	 * @throws Exception
	 ...
	 * @date 2018年9月24日
	 */
	void removeManualOders(List<PupManualOrderModel> list)throws Exception;
	/**
	 * 手工调整订单页面数据导出持久层接口
	 * @param model
	 * @return
	 ...
	 * @date 2018年9月24日
	 */
	List<PupManualOrderModel> queryManualOederForExport(PupManualOrderModel model)throws Exception;
	/**
	 * 根据UUID删除临时表数据持久层接口
	 * @param uuid
	 * @throws Exception
	 ...
	 * @author zmj
	 */
	List<String> queryUpdateList(Map<String, Object> paramMap)throws Exception;
	/**
	 * 查询需要更新导入的数据条数
	 * @param paramMap
	 * @return
