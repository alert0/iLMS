...
public interface PupManualOrderManager extends Manager<String, PupManualOrderModel>{
	 ...
	 * @date 2018年9月24日
	 */
	PageList<PupManualOrderModel> queryManualOrderForPage(PupManualOrderModel model,Page page)throws Exception;
	/**
	 * 手工调整订单删除数据业务层接口
	 * @param purchaseNo
	 * @throws Exception
	 ...
	 * @date 2018年9月24日
	 */
	void removeManualOders(String[] purchaseNo,String ipAddr)throws Exception;
	/**
	 * 手工调整订单页面数据导出业务层接口
	 * @param model
	 * @return
