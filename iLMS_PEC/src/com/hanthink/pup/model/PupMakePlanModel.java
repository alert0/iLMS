...
public class PupMakePlanModel extends AbstractModel<String> {
	...
	/** 实际取货日期 */
	private String firstPickDate;
	/** 实际取货时间 */
	private String firstPickTime;
	/** 卸货地点 */
	private String unloadPlace;
	/** 起始sortid */
	private String startSortId;
	/** 结束sortid */
	private String endSortId;
	/** 提前台套数 */
	...
	public String getFirstPickDate() {
		return firstPickDate;
	}
	public void setFirstPickDate(String firstPickDate) {
		this.firstPickDate = firstPickDate;
	}
	public String getFirstPickTime() {
		return firstPickTime;
	}
	public void setFirstPickTime(String firstPickTime) {
	...
	public String getEndSortId() {
		return endSortId;
	}
	public void setEndSortId(String endSortId) {
	...
	public String groupKey(){
        return this.routeCode + "_" + this.totalNo;
    }
}
