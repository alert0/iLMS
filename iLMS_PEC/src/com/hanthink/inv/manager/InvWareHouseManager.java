...
public interface InvWareHouseManager extends Manager<String, InvWareHouseModel>{
	 ...
	 * @date 2018年10月8日
	 */
	void updateWareHouse(InvWareHouseModel model, String string)throws Exception;
	/**
	 * 单条/批量数据删除业务接口
	 * @param ids
	 * @throws Exception
	 ...
	 * @date 2018年10月8日
	 */
	void deleteWareHouseByIds(String[] ids,String ipAddr)throws Exception;
	/**
	 * 获取ERP仓库下拉框
	 * @return
	 * @throws Exception
	 ...
	 * @date 2019年1月7日
	 */
	List<InvWareHouseModel> queryERPWareCode()throws Exception;
	/**
	 * 获取仓库类型下拉框
	 * @return
	 * @throws Exception
	 ...
	 * @date 2019年1月16日
	 */
	List<InvWareHouseModel> queryWareType()throws Exception;
