...
public class InvWareHouseDaoImpl extends MyBatisDaoImpl<String, InvWareHouseModel>
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<InvWareHouseModel> queryWareHosueName(InvWareHouseModel model) throws Exception {
		return (List<InvWareHouseModel>) this.getList("queryWareHosueName", model);
	}
	/**
	 * 修改仓库信息业务持久层实现方法
	 * @param model
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<InvWareHouseModel> queryERPWareCode(String factoryCode) throws Exception {
		return (List<InvWareHouseModel>) this.getList("queryERPWareCode", factoryCode);
	}
	/**
	 * 获取仓库类型下拉框
	 * @param factoryCode
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<InvWareHouseModel> queryWareType(String factoryCode) throws Exception {
		return (List<InvWareHouseModel>) this.getList("queryWareType", factoryCode);
	}
}
