...
/**
* <p>Title: SwSupplierGroupModel.java<／p>
* <p>Description: <／p>
...
public class SwSupplierGroupModel extends AbstractModel<String> {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -1180808937704405095L;
	/**id**/
	private String id;
	/**分组编码**/
