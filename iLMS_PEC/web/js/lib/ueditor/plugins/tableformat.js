...
UE.registerUI('tableformat',function(editor,uiName){
    ...
    var btn = new UE.ui.Button({
        ...
        cssRules : 'background-image:url("../../js/lib/ueditor/themes/default/images/css.png")!important;background-repeat: no-repeat;margin-left:5px;',
        //cssRules :'background-position: -523px -76px;',
        //点击时执行的命令
        onclick:function () {
...
UE.registerUI('applytableformat',function(editor,uiName){
    ...
    var btn = new UE.ui.Button({
        ...
        //需要添加的额外样式，指定icon图标，这里默认使用一个重复的icon
        //cssRules :'background-position: -550px -76px;',
        cssRules : 'background-image:url("../../js/lib/ueditor/themes/default/images/css_go.png")!important;background-repeat: no-repeat;margin-left:5px;',
        //点击时执行的命令
        onclick:function () {
            //这里可以不用执行命令,做你自己的操作也可
           editor.execCommand(uiName);
