...
<script type="text/javascript">
	...
	function getResult() {
		var data={};
		data.script=AngularUtil.getScope().code;
		data.description=AngularUtil.getScope().description||"[脚本]";
		return data;
	}
</script>
</head>
<body ng-controller="ctrl" ng-init="init()">
	<div style="margin-left: 30px;">
		...
		<a class="btn btn-primary btn-xs" ng-click="selectConditionScript(2)">人员脚本</a>
	...
	描述：<input type="text" class="inputText" style="width: 400px" ng-model="description" />
	</div>
</body>
</html>
