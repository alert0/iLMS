...
function downloadTemplateFn(){
	var downurl = encodeURI(encodeURI(__ctx + '/comm/comm/downloadExcelModel?fileName=取货计划查询导入模版.xlsx'));
		...
		success : function(responseText) {
			...
			if (resultMessage.isSuccess()) {
				...
				$.topCall.confirm("提示",showMsg,
					function(r) {
						if (!r) return;
						$('#importForm').attr("action", __ctx + "/pup/getPlan/planExcelImport");
						$('#importForm').submit();
					}
				);
			}
...
function isImportFn(){
	...
	var url=__ctx + "/pup/getPlan/isImport";
...
function downloadDataFn(){
	var downurl = encodeURI(__ctx + '/pup/getPlan/exportTempData');
	$('#downloadiframe').attr('src', downurl);
}
	
function loadGrid() {
	$('#grid').datagrid($.extend($defaultOptions,{
		url :  "queryImportForPage",
		idField : "id",
		sortName : 'ID',
		sortOrder : 'desc',
		fitColumns : false,
		...
		{field : 'totalBatchs',sortName : "TOTAL_BATCHS",title : '累计车次',align : 'center',sortable : 'true'}, 
		{field : 'mergeBatchs',sortName : "MERGE_BATCHS",title : '合并车次',align : 'center',sortable : 'true'}, 
		...
		{field : 'orderNo',sortName : "ORDER_NO",title : '物流订单号',align : 'center',sortable : 'true'}, 
		{field : 'purchaseNo',sortName : "PURCHASE_NO",title : '采购订号',align : 'center',sortable : 'true'}, 
		{field : 'workDate',sortName : "WORK_DATE",title : '工作日',align : 'center',sortable : 'true'}, 
		{field : 'todayCarBatch',sortName : "TODAY_CAR_BATCH",title : '当日车次',align : 'center',sortable : 'true'}, 
		{field : 'planPickupTime',sortName : "PLAN_PICKUP_TIME",title : '计划取货时间',align : 'center',sortable : 'true'}, 
		{field : 'planArrTime',sortName : "PLAN_ARR_TIME",title : '计划到货时间',align : 'center',sortable : 'true'}, 
		{field : 'planAssembleTime',sortName : "PLAN_ASSEMBLE_TIME",title : '计划装配时间',align : 'center',sortable : 'true'}, 
		{field : 'orderUse',sortName : "ORDER_USE",title : '订购用途',align : 'center',sortable : 'true'}, 
		{field : 'interLogisManager',sortName : "INTER_LOGIS_MANAGER",title : '内物流管理员',align : 'center',sortable : 'true'}, 
		{field : 'confirmDays',sortName : "CONFIRM_DAYS",title : '确认天数',align : 'center',sortable : 'true'}, 
