...
<body>
	...
	<form id="importForm" action="importForm" method="post" enctype="multipart/form-data">
		<table class="table-form" cellspacing="0">
			...
			<tr hidden="true" id="msg">
				...
				<td>
					<textarea rows="8" cols="60" id="content" class="inputText"></textarea>
