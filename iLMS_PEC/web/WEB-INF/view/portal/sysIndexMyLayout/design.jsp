...
<body class="edit">
      ...
      <ul class="nav pull-right" id="menu-layoutit">
        <li>
          <div class="btn-group" data-toggle="buttons-radio">	
           ...
           <%--  <c:if test="${sysIndexMyLayout.id != null }">
            <button class="btn  btn-xs btn-primary"   type="button" id="button-delete-modal" data-target="#delete" role="button" var="${sysIndexMyLayout.id}" ><i class="glyphicon glyphicon-remove"></i>删除设计模版</button>
            </c:if> --%>
	...
	<!--/row-->
  	...
  	<textarea id= "html" rows="0" cols="0" style="display: none;">${fn:escapeXml(sysIndexMyLayout.designHtml )}</textarea>
