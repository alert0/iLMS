    ...
    .controller('StencilController', ['$rootScope', '$scope', '$http', '$modal', '$timeout','$controller', '$compile', 'templateService', function ($rootScope, $scope, $http, $modal, $timeout,$controller, $compile, templateService) {
        ...
        $scope.pinyin = function(){
        	if($scope.modelData){
                ...
                if (!value) return;
                $http({method: 'POST', url: __ctx + "/pinyinServlet?Chinese="+value+"&type=0",Chinese:value}).success(function (data) {
                	$scope.modelData.defKey = data;
                });
        	}
        }
...
*/
                    ...
                    if (!selectedShape.properties['oryx-overrideid']) {
                    ...
                    $scope.safeApply(function () {
                        ...
                        if($scope.isAddNewNode && $scope.idProperty  && stencil.title().indexOf("Sequence") == -1 ){
