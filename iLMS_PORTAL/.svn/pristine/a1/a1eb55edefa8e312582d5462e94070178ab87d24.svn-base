...
<section class="bg-header">
	<div>
		<li class="logo" style="background:url(../css/image/logomtk-bf-05.png) no-repeat center;background-position: 2px center;">
			<a href="javascript:;">
				<h1 style="margin-left: 70px;font-size:18pt;">i-LMS系统</h1>
			</a>
		</li>
	</div>
