...
public class UserDaoImpl extends MyBatisDaoImpl<String, User> implements UserDao{
	 ...
	 * @return
	 * @author ZUOSL	
	 * @DATE	2018年12月10日 下午6:00:28
	 */
	@Override
	public int updateUserInfo(User user) {
		return this.updateByKey("updateUserInfoBySelf", user);
	}

	@Override
	public Integer querySupplierAccountStatus(String account) {
		return this.sqlSessionTemplate.selectOne(this.getNamespace()+".querySupplierAccountStatus", account);
	}
