 ...
 * 
 */
public class VentureForecastMonExportUtil  extends ExcelExportUtil {
	
	private SwVentureForecastMonManager manager;
...
//	private String releaseStatus;
	...
	public VentureForecastMonExportUtil(SwVentureForecastMonManager manager,
...
//		this.releaseStatus = model.getReleaseStatus();
	...
	private PageList<Map<String, Object>> queryDemandForecastDataFromDB(int pageNum) {
		...
		return manager.queryVentureForecastMonExportDataByPage(startMonthStr, endMonthStr, model, page);
	}
...
//        widthList.add(40);
        ...
        widthList.add(150);
        headerList.add("N月数量");
        columnList.add("MONTH_ONE");
        widthList.add(40);
        headerList.add("N+1月数量");
        columnList.add("MONTH_TWO");
        widthList.add(40);
        headerList.add("N+2月数量");
        columnList.add("MONTH_THREE");
        widthList.add(40);
