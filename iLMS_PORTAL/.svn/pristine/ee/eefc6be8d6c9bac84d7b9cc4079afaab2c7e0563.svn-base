...
<head>
	...
	<!-- <link rel="shortcut icon" href="${ctx}/css/image/favicon.ico"/> -->
	...
	<f:link href="other/indexOther.css"></f:link>
	<f:link href="other/index-other.css"></f:link>
	...
	<script type="text/javascript" src='${ctx}/js/platform/system/layout/indexOther.js'></script>
...
<body ng-controller="indexCtrl" class="easyui-layout" fit="true" scroll="no" >
	<div class="layout-north " region="north" style="padding-bottom: 10px;">
		<%@include file="/commons/include/headerOther.jsp"%>
	</div>
