...
<%@include file="/commons/include/home.jsp"%>
	<link rel="stylesheet" type="text/css" href="${ctx}/css/layoutit.css"></link>
	...
	<script type="text/javascript" src="${ctx}/js/hotent/index/jquery.htmlClean.js"></script>
...
<body class="edit">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="javascripts:void(0)">首页可视化布局</a>
    </div>
    <div class="collapse navbar-collapse">
      <ul class="nav pull-right" id="menu-layoutit">
        <li>
          ...
          <div class="btn-group">	
            <button class="btn  btn-xs btn-primary" id="button-save-modal"  role="button" data-toggle="modal"  data-target="#saveModal"><i class="glyphicon-floppy-disk glyphicon"></i>保存</button>
	      ...
	      <div class="modal-body">
				...
				<table class="table table-detail" cellpadding="0" cellspacing="0" border="0">
					<tr>
						<th width="20%">布局名称: </th>
						<td>
						<input type="text" id="name" name="name" value="${sysIndexLayoutManage.name}"  class="inputText" style="width: 80%;" validate="{required:true,maxlength:30}"/>
						</td>
					</tr>
					<tr>
						<th width="20%">布局描述: </th>
						<td>
							<input type="text" id="memo" name="memo"  value="${sysIndexLayoutManage.memo}"  class="inputText" style="width: 80%;" validate="{required:true,maxlength:50}"/>
						</td>
					</tr>
					<tr style="display: none;">
						<th width="20%">所属组织: </th>
						<td>
							<input type="hidden" id="orgId" name="orgId" value="${orgId}"  class="inputText"/>
							<input type="hidden" id="layoutType" name="layoutType" value="0"  class="inputText"/>
						</td>
					</tr>
					<tr>
