...
public interface SwSupplierGroupDao extends Dao<String, SwSupplierGroupModel>{
	...
	* @date   2018年10月13日 下午4:00:12
	...
	/**
	 * 
	 * @Description: 导出数据临时控制器
	 * @param @param paramMap
	 * @param @return   
	 * @return PageList<SwSupplierGroupModelImport>  
	 * @throws  
	 * @author luoxq
	 * @date 2018年11月28日 上午11:29:11
	 */
	...
	void insertSupplierGroupImportData(Map<String, String> paramMap);

	void insertGroupMembersImportData(Map<String, String> paramMap);
