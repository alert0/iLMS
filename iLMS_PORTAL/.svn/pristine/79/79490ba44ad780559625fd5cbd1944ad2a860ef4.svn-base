...
package com.hotent.bpmx.core.defxml.entity.omgdi;
 ...
 * generated in the com.hotent.bpmx.core.defxml.entity.omgdi package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.hotent.bpmx.core.defxml.entity.omgdi
     * 
     */
