...
var ZtreeCreator = function(treeId,url,initJson){
	...
	this.makeCombTree = function(isShowIn,width,height){
		...
		_isShowIn = isShowIn; 
		var menuContent ='<div id="'+_menuContent+'" style="width:'+width+'px; height:'+height+'px;overflow-y:auto; position:absolute;z-index: 9999;display:none;background-color:#F5F5F5">'
