...
public class SwDemondOrderDaoImpl extends MyBatisDaoImpl<String, SwDemondOrderDetailModel> implements SwDemondOrderDao{
	...
	@Override
	public void updateDemandOrderDeliveryStatus(SwDemondOrderDetailModel model) {
		this.updateByKey("updateDemandOrderDeliveryStatus", model);
	}

	@Override
	public void logBarCode(SwDemondOrderDetailModel swDemondOrderDetailModel_q, String ipAddr) {
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("model", swDemondOrderDetailModel_q);
		map.put("ipAddr", ipAddr);
		this.insertByKey("logBarCode", map);
	}
