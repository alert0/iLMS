...
public interface PupLockPlanDao extends Dao<String, PupLockPlanModel>{
	 ...
	 * @date 2018年9月25日
	 */
	List<PupLockPlanModel> queryLockPlanModelsForPage(PupLockPlanPageModel model,Page page)throws Exception;
	/**
	 * 锁定取货计划维护数据删除Dao层接口
	 * @param ids 一个/多个数据id
	 * @throws Exception 异常
	 ...
	 * @date 2018年9月26日
	 */
	List<PupLockPlanModel> queryLockPlanForExport(PupLockPlanPageModel model)throws Exception;
	/**
	 * 锁定取货计划维护数据导入Dao层接口
	 * @param file Excel文件
	 * @param ipAddr 用户IP地址
