  <#-- LayerSlider start -->
  <div class="widget-layerslider" style="width: 100%; height: ${model.height}px; margin: 0 auto;">

<#-- slide one start -->
<div class="ls-slide ls-slide1" data-ls="offsetxin: right; slidedelay: 7000; transition2d: 24,25,27,28;">

  <img src="${ctx}/styles/common/img/slide1/bg.jpg" class="ls-bg" alt="Slide background">
  ...
  <div class="ls-l ls-title" style="top: 96px; left: 35%; white-space: nowrap;" data-ls="
    ...
    scaleout: .5; 
    showuntil: 4000;
  ">BPMX<strong>开源、轻量级的</strong> 企业流程业务开发平台</div>
...
<div class="ls-slide ls-slide2" data-ls="offsetxin: right; slidedelay: 7000; transition2d: 110,111,112,113;">
  ...
  <img src="${ctx}/styles/common/img/slide2/bg.jpg" class="ls-bg" alt="Slide background">
...
<div class="ls-slide ls-slide3" data-ls="offsetxin: right; slidedelay: 7000; transition2d: 92,93,105;">
  ...
  <img src="${ctx}/styles/common/img/slide3/bg.jpg" class="ls-bg" alt="Slide background">
  ...
  scaleout: .5; 
  showuntil: 4000;
  ">BPMX<strong>开源、轻量级的</strong> 企业流程业务开发平台
  </div>
...
<div class="ls-slide ls-slide4" data-ls="offsetxin: right; slidedelay: 7000; transition2d: 110,111,112,113;">
  ...
  <img src="${ctx}/styles/common/img/slide5/bg.jpg" class="ls-bg" alt="Slide background">
  ...
  scaleout: .5; 
  showuntil: 4000;">
  BPMX<br><strong>开源、轻量级的</strong><br> 企业流程业务开发平台
  </div>
  ...
  showuntil: 4000;">
  <span>咨询电话：</span>
  <a href="javascript:;">400-0668-262</a>
  </div>
