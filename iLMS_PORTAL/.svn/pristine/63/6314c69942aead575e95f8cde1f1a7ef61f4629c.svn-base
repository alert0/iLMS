 ...
 * </pre>
 */
public class SysResource extends AbstractModel<String> implements Tree{
	
	/** 资源类型-菜单 */
	public static final String SYS_RES_TYPE_MENU = "menu";
	/** 资源类型-AJAX操作请求 */
	public static final String SYS_RES_TYPE_REQAJAX = "reqajax";
	/** 资源类型-文件下载操作请求 */
	public static final String SYS_RES_TYPE_REQFILE = "reqfile";
	...
	*/
	...
	/** 资源类型 */
	private String sysResType = SYS_RES_TYPE_MENU;
	...
	public String getSysResType() {
		return null == sysResType ? SYS_RES_TYPE_MENU : sysResType;
	}

	/**
	 * @param 资源类型
	 */
	public void setSysResType(String sysResType) {
		this.sysResType = null == sysResType ? SYS_RES_TYPE_MENU : sysResType;
	}
	...
	public String toString() {
		...
		.append("sn", this.sn) 
		.append("SYS_RES_TYPE", this.sysResType)
		.toString();
	}
