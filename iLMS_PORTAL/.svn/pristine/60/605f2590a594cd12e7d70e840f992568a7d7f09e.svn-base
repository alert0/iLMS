...
$(function(){
	/**
	 * 用于触发绑定angularjs 的ngModel的属性值。
	 */
	var onpickedAndCleared=function(){
	 ...
	 * 	">
	 */
	$(document).delegate(".dateformat",'focus',function(){
		var format=$(this).attr('ht-date') ||'yyyy-MM-dd';
		WdatePicker({dateFmt:format,alwaysUseStartDate:true,onpicked:onpickedAndCleared,oncleared:onpickedAndCleared});
		$(this).blur();
	});
...
//	$('.wdateTime').live('focus',function(){
	$(document).delegate(".wdateTime",'focus',function(){
...
//	$('.datePicker').live('focus',function(){
	$(document).delegate(".datePicker",'focus',function(){
