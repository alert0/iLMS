(function() {
  var $, animationStyle, chromeTabs, defaultNewTabData, tabTemplate, noCloseTabTemplate;
  ...
  noCloseTabTemplate = '<div class="chrome-tab">\n    <div class="chrome-tab-favicon"></div>\n    <div class="chrome-tab-title"></div>\n        <div class="chrome-tab-curves">\n        <div class="chrome-tab-curves-left-shadow"></div>\n        <div class="chrome-tab-curves-left-highlight"></div>\n        <div class="chrome-tab-curves-left"></div>\n        <div class="chrome-tab-curves-right-shadow"></div>\n        <div class="chrome-tab-curves-right-highlight"></div>\n        <div class="chrome-tab-curves-right"></div>\n    </div>\n</div>';
  defaultNewTabData = {
    title: 'New Tab',
    favicon: '',
    iconClass:'',
  ...
  chromeTabs = {
    ...
    addNewTab: function($shell, newTabData) {
    	...
    	$shell.find('.chrome-tab').each(function() {
            var $tab;
            $tab = $(this);
            var tabId = $tab.data('tabData').data.tabId;
            var newTabId = newTabData.data.tabId;
            if (newTabId == tabId) {
            	isExist = true;
            	$newTab = $tab;
            }
    	...
    	$newTab = $(tabTemplate);
      if(newTabData.data.tabId.indexOf("myHome") > -1){
    	  $newTab = $(noCloseTabTemplate);
      }
    ...
    updateTab: function($shell, $tab, tabData) {
      ...
      if (tabData.iconClass) {
          $tab.find('.chrome-tab-favicon').addClass(tabData.iconClass);
      }
