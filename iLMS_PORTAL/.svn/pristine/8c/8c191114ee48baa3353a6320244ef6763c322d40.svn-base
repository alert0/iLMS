...
public class MpAdjSupFeedbackController extends GenericController{
	...
	public void downloadMpAdjSupFeedbackModel(HttpServletRequest request,HttpServletResponse response
		...
		String[] headers = {"零件号","简号","零件名称", "供应商代码", "出货地","供应商名称",
				"差异数量","是否可供应","供应原因","反馈时间", "供应时间","供应商用户状态"};
		String[] columns = {"partNo","partShortNo","partNameCn", "supplierNo", "supFactory","supplierName",
				"diffNum","codeValueName","supplyReason","feedbackTimeStr","supplyDateStr", "codeValueNameF"};
