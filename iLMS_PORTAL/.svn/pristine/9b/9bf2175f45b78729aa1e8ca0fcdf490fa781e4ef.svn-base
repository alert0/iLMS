...
public interface PupProPlanManager extends Manager<String, PupProPlanModel>{
	 ...
	 */
	PageList<PupProPlanModel> queryProPlanForPage(PupProPlanPageModel plan,Page page) throws Exception;
	/**
	 * 生产计划导出数据查询
	 *@author zmj
	 *@param plan 查询条件VO
	 ...
	 */
	List<PupProPlanModel> queryPupPlanBykey(PupProPlanPageModel plan) throws Exception;
	/**
	 * 通过UUID删除导入数据
	 *@author zmj
	 *@param uuid
	 ...
	 * @date 2018年9月17日
	 */
	PageList<PupProPlanModel> getProPlan(PupProPlanPageModel model)throws Exception;
}
