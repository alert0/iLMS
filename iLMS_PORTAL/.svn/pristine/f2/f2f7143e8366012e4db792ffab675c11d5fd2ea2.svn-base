 ...
 * 
 */
public class DemandForecastWeekExportUtil  extends ExcelExportUtil {
	...
	public DemandForecastWeekExportUtil(SwDemandForecastManager manager,
	...
	private PageList<Map<String, Object>> queryDemandForecastDataFromDB(int pageNum) {
		...
		return manager.queryDemandForecastWeekExportDataByPage(startMonthStr, endMonthStr, model, page);
	}
...
//		cal.add(Calendar.DAY_OF_YEAR, -1);
        ...
        widthList.add(150);
        headerList.add("零件物流模式");
        columnList.add("LOGISTICS_MODE");
        widthList.add(60);
        headerList.add("发布周");
        columnList.add("PUBLISH_WEEK");
        widthList.add(80);
...
//			System.out.println(sdfHymd.format(curDay));
        ...
        headerList.add("反馈状态");
        columnList.add("FEEDBACK_STATUS");
        widthList.add(40);
        headerList.add("发布状态");
        ...
        widthList.add(40);
        headerList.add("反馈备注");
        columnList.add("FEEDBACK_REMARK");
        widthList.add(170);
