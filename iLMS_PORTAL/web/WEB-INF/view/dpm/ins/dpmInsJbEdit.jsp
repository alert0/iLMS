	...
	$(function() {
		$.ajax({
		    ...
		    success: function(result){
		    	...
		    	$('#applyDep').val(result.applyDep);
		    	$('#insDate').val(result.insDate);
		    	$('#discoArea').val(result.discoArea);
...
<body ng-controller="ctrl">
	...
	<div class="toolbar-panel">
		<div class="buttons">
			<a class="btn btn-sm btn-primary fa-save" ng-model="data" ng-disabled="btnDisable.save" ht-save="${ctx}/dpm/ins/save?dpmType=2"><span>保存</span></a> 
		...
		<div title="基础信息" style="padding: 10px;">
			<form name="form" method="post" ht-load="${ctx}/dpm/ins/curdgetJson?applyNo=${param.applyNo}" ng-model="data">
				...
				<tr>
						...
						<td><input id="applyDep" name="applyDep" class="inputText" type="text" ng-model="data.applyDep" readonly="readonly" ht-validate="{required:false,maxlength:33}" /></td>
				   ...
				   <tr>
					...
					<tr>
					   ...
					   <th><span>责任组:</span><span class="required">*</span></th>
						<td><select id="respDep" class="inputText" type="text" ng-model="data.respDep"  ht-validate="{required:true,maxlength:20}" ></select></td>
					    
					</tr>
					<tr>
					    
						<th><span>不良品项目:</span><span class="required">*</span></th>
						<td><select id="dpmCode" class="inputText" type="text" ng-model="data.dpmCode"  ht-validate="{required:true,maxlength:20}" ></select></td>
					    <th><span>不良描述:</span></th>
						<td><input class="inputText" type="text" ng-model="data.dpmDesc" ht-validate="{required:false,maxlength:100}" /></td>
					</tr>
					<tr>
					    <th><span>发现区域:</span></th>
						<td><input id="discoArea" class="inputText" type="text"  ng-model="data.discoArea" readonly="readonly" ht-validate="{required:false,maxlength:20}" />
						</td>
					...
					<tr>
						...
						<td><input id="supplierTelNo" class="inputText" type="text" ng-model="data.telNo" readonly="readonly" ht-validate="{required:false,maxlength:300}" /></td>
					    <th><span>供应商担当:</span></th>
						<td><input id="supplierContact" class="inputText" type="text" ng-model="data.contact" readonly="readonly" ht-validate="{required:false,maxlength:300}" /></td>
