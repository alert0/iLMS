	...
	function loadGrid() {
		$('#grid').datagrid($.extend($defaultOptions,{
			...
			columns : [ [
		     ...
		     {field : 'account',sortName : "u.account_",title : '账号',width : 130,align : 'center',sortable : 'true'},
		     {field : 'relName',title : '岗位名称',width : 130,align : 'center'},
			{field : 'isMaster',sortName : "orguser.is_master_",title : '是否主组织',width : 80,align : 'center',
			...
			{field : 'isCharge',sortName : "orguser.is_charge",title : '负责人',width : 80,align : 'center',
				 formatter:function(value){
			...
			{field : 'createTime',sortName : "u.create_time_",title : '创建时间',width : 150,align : 'center',sortable : 'true',formatter:dateTimeFormatter}, 
