...
implements SwSupplierGroupManager{
	...
	* @date   2018年10月11日 下午10:38:10
	...
	public SwSupplierGroupModel getByGroupName(SwSupplierGroupModel swSupplierGroupModel) {
		return swSupplierGroupDao.getByGroupName(swSupplierGroupModel);
	}
	...
	* @date   2018年10月12日 上午9:40:39
	...
	public void removeAndLogByIds(String[] groupIds, String ipAddr) {
		...
		logVO1.setTableName("MM_SW_SUP_GROUP_MEMBERS");
		TableColumnVO pkColumnVO1 = new TableColumnVO();
		pkColumnVO1.setColumnName("GROUP_ID");
		pkColumnVO1.setColumnValArr(groupIds);
...
//        swSupplierGroupDao.deleteNotDealData(paramMap);
        swSupplierGroupDao.insertSupplierGroupImportData(paramMap); //导入供应商分组表
        swSupplierGroupDao.insertGroupMembersImportData(paramMap); // 导入供应商分组信息表
