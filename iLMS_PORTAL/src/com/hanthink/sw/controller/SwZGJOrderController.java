...
public class SwZGJOrderController extends GenericController{
	 ...
	 * @author: dtp
	 * @date: 2019年3月23日
	 * modified by lxq 新增全部发货按钮：iLMS2019042501
	 */
...
//					}
	...
	public void updateAllOrderObj(HttpServletRequest request, HttpServletResponse response,
		...
		try {
			...
			model.setFactoryCode(user.getCurFactoryCode());
			model.setPurchaseNoArr(model.getPurchaseNo());
			swZGJOrderManager.updateAllOrderObj(model, RequestUtil.getIpAddr(request));
