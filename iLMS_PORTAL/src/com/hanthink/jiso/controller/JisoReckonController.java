...
public class JisoReckonController extends GenericController{
	...
	public void downloadJisoVehQueuePage(HttpServletRequest request,HttpServletResponse response,
		...
		if(null != list) {
			String[] headers = {"PA OFF时间", "VIN", "车型", "阶段", "车身序号", "组票状态", "组单状态", "计划下线批次进度"};
			String[] columns = {"passTime", "vin", "modelCode", "phase", "wcSeqno", "groupInsState", "groupOrderState", "kbProductSeqno"};
			int[] widths = {120, 100, 100, 100, 100, 100, 100, 100};
