...
public class ServiceTest {
    ...
    public void testClient() {
        ...
        //项目运行起来后，测试配置问题
        String url = "http://10.88.52.7:8080/SmartWorkESB/services/Service"; //webservice
        String actionURL = "http://localhost/BOI//Invoke"; //方法父节点的targetNamespace+方法名
        ...
        IfConfigures.getQueryParam().put("FROM", "MES_gacne@2017");
        IfConfigures.getQueryParam().put("FUN_NAME", "XXX_AD08");
